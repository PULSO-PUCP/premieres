...
Mixed effects coxme model
 Formula: Surv(interval_duration, event) ~ regime_fujimori + speech_window +      (1 | presidentofExecutive) 
    Data: intervals_AG 
...
1 presidentofExecutive Intercept 0.01999358 0.0003997433
                  Chisq   df      p  AIC    BIC
Integrated loglik  1.40 3.00 0.7061 -4.6 -10.78
 Penalized loglik  1.43 2.02 0.4919 -2.6  -6.75

Fixed effects:
                   coef exp(coef) se(coef)     z     p
regime_fujimori -0.4169    0.6591   0.3900 -1.07 0.285
speech_window   -0.1571    0.8546   0.2768 -0.57 0.570
\end{Soutput}
\end{Schunk}
