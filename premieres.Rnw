...
<<coxInvar,echo=FALSE, results=tex>>=
library(survival)
linkGit='https://github.com/PULSO-PUCP/pcm_history/raw/refs/heads/main/spellsModel.xlsx'
...
stargazer::stargazer(cox_model,label = "coxInvar",dep.var.labels = "Survival in Office",font.size = "small")
@
